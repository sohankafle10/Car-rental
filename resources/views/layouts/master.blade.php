...
<body class="font-sans text-gray-900 bg-gray-100">
    ...
    <header class="bg-white">
        <nav class="fixed top-0 left-0 z-50 w-full bg-gray-100 shadow-md">
            <div class="container flex items-center justify-between px-4 py-4 mx-auto md:px-0">
                <!-- Logo -->
                <a href="{{ route('home') }}">
                    <img src="{{ asset('img/logoo.png') }}" alt="CarRental Logo" class="h-16">
                </a>
                ...
                <div class="items-center hidden space-x-4 md:flex lg:order-2">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <form action="{{ route('logout') }}" method="POST">
                            @csrf
                            <button type="submit"
                                class="px-4 py-2 text-white bg-gradient-to-br from-purple-500 to-purple-400 hover:bg-gradient-to-bl font-medium rounded-lg text-sm">
                                Logout
                            </button>
                        </form>
                    </div>
        ...
        <div class="container grid grid-cols-1 gap-8 px-4 mx-auto md:grid-cols-2 lg:grid-cols-5 md:px-0">
            ...
            <div class="lg:col-span-2">
                ...
                <p class="ml-5 text-gray-400">
                    Established in 2024, Bro's CAR RENTAL is Nepal's leading car rental company.
                </p>
            </div>
            <!-- Contact Info -->
            <div>
            ...
            <div>
                ...
                <div class="flex space-x-4">
                    ...
                    <a href="https://www.instagram.com/" class="hover:text-blue-400"><i class='bx bxl-instagram'></i></a>
                    <a href="https://www.linkedin.com/" class="hover:text-blue-400"><i class='bx bxl-linkedin'></i></a>
                </div>
            </div>
        </div>
    </footer>
    ...
    <div class="py-2 text-center text-white bg-gray-900 copyright">
        <p>&#169; All Rights Reserved Bro's CAR RENTAL</p>
    </div>
